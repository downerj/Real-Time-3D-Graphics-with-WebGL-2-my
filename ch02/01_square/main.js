...
class Application {
  ...
  #initializeBuffers() {
    ...
    const squareBufferData = new ProgramBufferData();
    squareBufferData.vertexBuffer = squareVertexBuffer;
    squareBufferData.indexBuffer = squareIndexBuffer;
    squareBufferData.indexCount = indices.length;
    this.#bufferData.push(squareBufferData);
  }
